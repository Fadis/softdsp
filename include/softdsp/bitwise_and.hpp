#ifndef SOFTDSP_BITWISE_AND_HPP
#define SOFTDSP_BITWISE_AND_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class bitwise_and {
    public:
      bitwise_and( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      bitwise_and( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
