#ifndef SOFTDSP_SHIFT_RIGHT_ASSIGN_HPP
#define SOFTDSP_SHIFT_RIGHT_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class shift_right_assign {
    public:
      shift_right_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      shift_right_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
      ...
      operator()(
        ...
        shift_right< Context > oper_( tools );
