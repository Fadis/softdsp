#ifndef SOFTDSP_EQUAL_TO_HPP
#define SOFTDSP_EQUAL_TO_HPP
      ...
      return_value< bool > operator()(
        ...
        typename boost::enable_if<
          boost::mpl::and_<
            ...
            boost::is_float< typename usual_arithmetic_conversions< LeftType, RightType >::type >
          >
        >::type* = 0
      ) {
        ...
        return
          return_value< bool >(
            tools->ir_builder.CreateFCmpEQ( left.value, right.value )
          );
      }
      template< typename LeftType, typename RightType >
      return_value< bool > operator()(
        ...
        typename boost::enable_if<
          boost::mpl::and_<
            at_least_one_operand_is_llvm_value< LeftType, RightType >,
            boost::is_integral< typename usual_arithmetic_conversions< LeftType, RightType >::type >
          >
        >::type* = 0
      ) {
        typedef typename usual_arithmetic_conversions< LeftType, RightType >::type result_type;
        ...
        return
          return_value< bool >(
            tools->ir_builder.CreateICmpEQ( left.value, right.value )
          );
      }
      template< typename LeftType, typename RightType >
      auto operator()(
