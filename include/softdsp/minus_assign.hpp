#ifndef SOFTDSP_MINUS_ASSIGN_HPP
#define SOFTDSP_MINUS_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class minus_assign {
    public:
      minus_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      minus_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
