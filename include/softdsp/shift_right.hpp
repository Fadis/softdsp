#ifndef SOFTDSP_SHIFT_RIGHT_HPP
#define SOFTDSP_SHIFT_RIGHT_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class shift_right {
    public:
      shift_right( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      shift_right( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
      ...
      operator()(
        ...
        typename static_cast_< unsigned int >::template eval< Context > cast( tools );
        ...
        return return_value<
          ...
          >::type
        >(
          tools->ir_builder.CreateLShr( left.value, right.value )
        );
      }
      template< typename LeftType, typename RightType >
      return_value<
      ...
      operator()(
        ...
        return return_value<
          ...
          >::type
        >(
          tools->ir_builder.CreateAShr( left.value, right.value )
        );
      }
      template< typename LeftType, typename RightType >
      auto operator()(
