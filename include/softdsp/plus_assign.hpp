#ifndef SOFTDSP_PLUS_ASSIGN_HPP
#define SOFTDSP_PLUS_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class plus_assign {
    public:
      plus_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      plus_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
