#ifndef SOFTDSP_COMPLEMENT_HPP
#define SOFTDSP_COMPLEMENT_HPP
  ...
  namespace keywords {
    ...
    public:
      ...
      operator()(
        ...
        return return_value< raw_type >(
          tools->ir_builder.CreateXor(
            value.value,
            tools->ir_builder.CreateSub( zero.value, one.value )
          )
        );
      }
      template< typename ValueType >
