#ifndef SOFTDSP_BITWISE_OR_HPP
#define SOFTDSP_BITWISE_OR_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class bitwise_or {
    public:
      bitwise_or( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      bitwise_or( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
