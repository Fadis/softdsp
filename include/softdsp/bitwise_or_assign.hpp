#ifndef SOFTDSP_BITWISE_OR_ASSIGN_HPP
#define SOFTDSP_BITWISE_OR_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class bitwise_or_assign {
    public:
      bitwise_or_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      bitwise_or_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
      ...
      operator()(
        ...
        bitwise_or< Context > oper_( tools );
