#ifndef SOFTDSP_BITWISE_XOR_ASSIGN_HPP
#define SOFTDSP_BITWISE_XOR_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    class bitwise_xor_assign {
    public:
      bitwise_xor_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      bitwise_xor_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
      ...
      operator()(
        ...
        bitwise_xor< Context > oper_( tools );
