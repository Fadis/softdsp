#ifndef SOFTDSP_DIVIDES_ASSIGN_HPP
#define SOFTDSP_DIVIDES_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    public:
      divides_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      divides_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
