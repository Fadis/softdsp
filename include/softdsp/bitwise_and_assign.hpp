#ifndef SOFTDSP_BITWISE_AND_ASSIGN_HPP
#define SOFTDSP_BITWISE_AND_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    public:
      bitwise_and_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      bitwise_and_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
      ...
      operator()(
        ...
        bitwise_and< Context > oper_( tools );
