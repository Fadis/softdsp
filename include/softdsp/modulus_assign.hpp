#ifndef SOFTDSP_MODULUS_ASSIGN_HPP
#define SOFTDSP_MODULUS_ASSIGN_HPP
...
namespace softdsp {
  ...
  namespace keywords {
    ...
    public:
      modulus_assign( const Context &context_ ) : tools( context_.get_toolbox() ) {}
      modulus_assign( const typename Context::toolbox_type &tools_ ) : tools( tools_ ) {}
